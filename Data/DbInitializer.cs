...
public static class DbInitializer
{
    ...
    private static List<CourseSeed> CreateCourseCatalog()
    {
        return
        [
            new CourseSeed("CSC101", "Introduction to Programming", 3, "SE,IT", 1000),
            new CourseSeed("CSC102", "Web Development Fundamentals", 3, "SE,IT", 1200),
            new CourseSeed("CSC201", "Object-Oriented Programming", 3, "SE", 1100),
            new CourseSeed("CSC230", "Database Systems", 3, "SE,IT,DA", 1300),
            new CourseSeed("CSC240", "Computer Networks", 3, "IT,CY", 1250),
            new CourseSeed("CSC245", "Cloud Fundamentals", 3, "IT,CY", 1400),
            new CourseSeed("CSC310", "Data Structures and Algorithms", 3, "SE", 1500),
            new CourseSeed("AIS260", "Applied Business Analytics", 3, "BA,DA", 1350),
            new CourseSeed("DAT250", "Data Visualization", 3, "BA,DA", 1150),
            new CourseSeed("CLD270", "Cloud Infrastructure Services", 3, "IT,CY", 1600),
            new CourseSeed("CYB220", "Fundamentals of Cyber Security", 3, "IT,CY", 1700),
            new CourseSeed("MOB230", "Mobile Application Development", 3, "SE", 1550),
            new CourseSeed("UXD210", "User Experience Design", 3, "SE,DA", 1450),
            new CourseSeed("MAT201", "Discrete Mathematics", 3, string.Empty, 1800),
            new CourseSeed("MAT210", "Applied Calculus", 3, string.Empty, 1750),
            new CourseSeed("STA210", "Business Statistics", 3, "BA,DA", 1900),
            new CourseSeed("ENG150", "Academic Writing", 2, string.Empty, 2000),
            new CourseSeed("COM110", "Communication Skills", 2, string.Empty, 2100),
            new CourseSeed("HIS220", "Malaysian Civilisation", 2, string.Empty, 2200),
            new CourseSeed("LAW160", "Business Law", 2, "BA", 2300),
            new CourseSeed("ACC110", "Principles of Accounting", 3, "BA,DA", 2400),
            new CourseSeed("BUS205", "Entrepreneurship and Innovation", 3, "BA", 2500),
            new CourseSeed("ECO120", "Microeconomics", 3, "BA,DA", 2600),
            new CourseSeed("FIN215", "Personal Finance and Banking", 3, "BA,DA", 2700),
            new CourseSeed("MKT225", "Digital Marketing Fundamentals", 3, "BA,DA", 2800)
        ];
    }
